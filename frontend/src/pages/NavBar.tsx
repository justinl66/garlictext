...
export default function NavBar() {
  ...
  return (
    <nav className="w-full bg-gradient-to-r from-[#9B5DE5] via-[#00BBF9] to-[#F15BB5] px-6 py-3 flex justify-between items-center shadow-lg">
      ...
      <div className="flex space-x-6 items-center text-white font-sans font-semibold text-sm">
        ...
        <Link to="/join" className="hover:text-[#FEE440] transition">Join Game</Link>
        <Link to="/create" className="hover:text-[#FEE440] transition">Create Game</Link>
      </div>
    </nav>
  );
}